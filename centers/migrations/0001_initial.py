# Generated by Django 5.0 on 2024-03-01 21:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teaching_format', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author', models.ForeignKey(default='delated author', on_delete=django.db.models.deletion.SET_DEFAULT, to='centers.author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateField(auto_now_add=True)),
                ('update_at', models.DateField(auto_now=True)),
                ('center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='center_review', to='centers.center')),
